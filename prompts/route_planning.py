...
gpt_4_vision_vot = client.chat.completions.create(
    model = "gpt-4-turbo",
    messages = [
        {
            "role": "system",
        ...
        },
        {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "Now given the image of the map, starting from the Home position, provide the steps to navigate to Office position. Visualize the state after each reasoning step."
                },
                {
                    "type": "image_url",
...
print(gpt_4_vision_vot.choices[0].message.content)
